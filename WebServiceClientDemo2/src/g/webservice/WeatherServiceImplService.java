 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://webservice.g/", wsdlLocation = "http://localhost:8080/WebServiceServerDemo2/ws/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://webservice.g/", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceServerDemo2/ws/weather?wsdl");
    ...
    public IWeatherService getWeatherServiceImplPort() {
        return super.getPort(new QName("http://webservice.g/", "WeatherServiceImplPort"), IWeatherService.class);
    }
    ...
    public IWeatherService getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.g/", "WeatherServiceImplPort"), IWeatherService.class, features);
    }
